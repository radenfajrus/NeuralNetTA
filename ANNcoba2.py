...
class MLP(object):
	...
	def test_mlp(learning_rate=0.01, L1_reg = 0.01, L2_reg=0.0001, n_epoch = 1000,dataset ='',
		...
		classifier = MLP(rng=rng, input = x, n_in =nFeat, n_hidden1= n_hidden1, n_hidden2= n_hidden2, n_out= )
		...
		while (epoch < n_epochs) and (not_done_looping):
			...
			for minibatch_index in range(n_train_batches):
				...
				if(iter + 1) %validation_frequency == 0:
					...
					this _validation_loss = np.mean(validation_loss)
